...
pii q=a.p2();
a.shift(q.X,q.Y);b.shift(q.X,q.Y);c.shift(q.X,q.Y);
ll A=d2(a.x1,a.y1);ll B=d2(b.x2,b.y2);ll D=d2(a.x1-b.x2,a.y1-b.y2);
...
if (solve (a,b,c) ||solve (a,c,b) ||solve (b,a,c) ||solve (b,c,a) ||solve (c,a,b) ||solve (c,b,a)) cout<<"YES"<<endl;
else cout<<"NO"<<endl;
}
