...
(N/1) + (N/2) + (N/3) +...... = N logN
*/
// Max limit of double is 10^308

ll arr[310], lps[310], N, arr1[310], arr2[310], tot, res;
string stt[310];
map<string, ll> ma;
void kmpp(ll st, ll en)
{
    ll p1 = 0, p2 = 0, ans = 0, i, j, len = 0;
    rep(i, st, en)
    {
        arr1[p1++] = arr[i];
    }
    ...
    if( ans>=1 )
    {
        ...
        res = min(res, tot-leng+ans*(en-st+1));
    }
}
int main()
{
