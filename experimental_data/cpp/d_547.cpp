...
int main()
{
    ...
    FOR(i,1,n+1)
    {
    	...
    	if(!foundx[x]) foundx[x]=i;
    	else
    	{
    		graph[i].emplace_back(foundx[x]);
    		graph[foundx[x]].emplace_back(i);
    		foundx[x]=0;
    	}

    	if(!foundy[y]) foundy[y]=i;
    	else
    	{
    		graph[i].emplace_back(foundy[y]);
    		graph[foundy[y]].emplace_back(i);
    		foundy[y]=0;
    	}
    }
    ...
    FOR(i,1,n+1) {if(!color[i]) cout<<"b"; else cout<<"r";} cout<<endl;
