...

{
   ...
   fio;
...

    {
        ...
        int char1=97, char2=97, char3=97, a=97, z=122;
...

        {
...

            {
...

                {
                    ...
                    if (char(char1) == line[i] and char(char2)==line[i+1])
...

                {
                    ...
                    cout << char(char1) << char(char2) << endl;
...

            {
...

                {
...

                    {
                        ...
                        if (char(char1) == line[i] and char(char2) == line[i + 1] and char(char3)==line[i+2])
...

                    {
                        ...
                        cout << char(char1) << char(char2) << char(char3) << endl;
