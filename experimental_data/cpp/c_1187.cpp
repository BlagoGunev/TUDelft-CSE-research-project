...
public:
    ...
    ll get(ll l, ll r) { assert(l <= r && l >= 0 && r <= (ll)sum.size());return sum[r] - sum[l]; } //[l,r)
};
// CumulativeSum Sum(v);Sum.get(l,r)=sum of [l,r)
...
//[ok,ng). a pair is not necessarily ok < ng.
/*/

/*/
vector<ll> za(vector<ll> a) {
vector<ll> b = a;
sort(b.begin(), b.end());
...
/*/
ll ans, ret, cnt, cur, sum, f,g;

int a[2000];//a[i]=iとi+1がt=1か否か
