...
void solve() {
     int a1, a2, a4, a5;
        ...
        // Check all possible values of a3 to maximize Fibonacciness
        for (int a3 = -20000; a3 <= 20000; ++a3) {
            int fibCount = 0;
            ...
            // Update the maximum Fibonacciness
            maxFibonacciness = max(maxFibonacciness, fibCount);
        }

        // Output the maximum Fibonacciness for this test case
